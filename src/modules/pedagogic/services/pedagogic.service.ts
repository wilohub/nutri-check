  ...
  async evaluateProductForCitizen(barcode: string): Promise<EvaluationResponseDto> {
    ...
    if (!product || !product.nutritionalData) {
      throw new NotFoundException(
        `El producto con código ${barcode} no tiene registro nutricional.`,
      );
    }
    ...
    let healthTip =
      'Este producto tiene un perfil balanceado. Puedes consumirlo con tranquilidad dentro de tu dieta diaria.';
